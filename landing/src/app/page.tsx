        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className={`flex items-center transform transition-all duration-500 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
              ...
              <span className="text-xl font-bold text-gray-900">LabAxis Medical Services</span>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 animate-fade-in-up">
              Why Choose LabAxis Medical Services?
            </h2>
            ...
            <div className="animate-fade-in-left">
              <div className="space-y-6">
                {[
                  ...
                  { Icon: Mail, title: "Email", info: "labaxis.com", delay: "0.2s" },
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="animate-fade-in-up">
              <div className="flex items-center mb-4">
                ...
                <span className="text-xl font-bold">LabAxis Medical Services</span>
              </div>
            ...
            {[
              ...
              { title: "Contact Info", links: ["+1 (555) 123-4567", "info@labaxis.com", "456 Healthcare Plaza", "Medical District, MD 54321"] }
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 animate-fade-in-up" style={{ animationDelay: '1s' }}>
            <p>&copy; 2024 LabAxis Medical Services. All rights reserved. | Privacy Policy | Terms of Service</p>
          </div>
        </div>
      </footer>
    </div>
