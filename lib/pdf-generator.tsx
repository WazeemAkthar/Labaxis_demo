    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>LabAxis Medical Laboratory Services</Text>
          ...
          <Text style={styles.subtitle}>Email: info@labaxis.com</Text>
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Thank you for choosing LabAxis Medical Laboratory Services for your healthcare needs.
          </Text>
          <Text style={styles.footerText}>
            For questions about this invoice, please contact us at info@labaxis.com
          </Text>
        </View>
      </Page>
    </Document>
