        ...
        <Card className="print:shadow-none">
          <CardHeader className="pb-6">
            <div className="flex items-start justify-between">
              <div>
                <CardTitle className="text-2xl mb-2">LabAxis Medical Laboratory Services</CardTitle>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="pt-6 border-t text-center text-sm text-muted-foreground">
              <p>Thank you for choosing LabAxis Medical Laboratory Services for your healthcare needs.</p>
              <p className="mt-2">For questions about this invoice, please contact us at info@labaxis.com</p>
            </div>
          </CardContent>
        </Card>
